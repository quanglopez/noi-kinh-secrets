    ...
    >
      <div className="flex w-full items-center justify-between flex-row-reverse">
        <div className="w-1/2 pl-12">
          ...
          <motion.h2 
            className="text-[#F5E6C8] text-[4.5vw] font-serif font-bold leading-tight mb-6"
          ...
          >
            ...
            <span className="text-[1.2vw] text-white/60">4.8/5 (142 Đánh giá)</span>
          </motion.div>
          <motion.p 
            className="text-[1.5vw] text-white/80 leading-relaxed border-r-2 border-[#8B1A1A] pr-6 text-right"
            initial={{ opacity: 0 }}
            animate={phase >= 3 ? { opacity: 1 } : { opacity: 0 }}
            transition={{ duration: 0.8 }}
          >
            Phục hồi sinh lực, giữ lửa tình yêu lứa đôi qua 21 bí thuật phòng trung cổ xưa.
          </motion.p>
        </div>
        ...
        >
          <img 
            src={biKipCover} 
            alt="21 Bí Kíp Phòng The" 
            className="w-full h-auto drop-shadow-2xl object-contain border-4 border-[#8B1A1A]/30"
          />
        </motion.div>
      </div>
    </motion.div>
