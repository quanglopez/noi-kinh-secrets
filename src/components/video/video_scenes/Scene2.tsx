      ...
      <div className="flex w-full items-center justify-between">
        <div className="w-1/2 pr-12">
          ...
          >
            ...
            <span className="text-[1.2vw] text-white/60">4.9/5 (218 Đánh giá)</span>
          </motion.div>
          <motion.p 
            ...
            transition={{ duration: 0.8 }}
          >
            4000 năm tinh hoa Đông y về dưỡng sinh, phòng bệnh và kéo dài tuổi thọ.
          </motion.p>
        </div>
